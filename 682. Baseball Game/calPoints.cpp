...
Approach: Declare a vector `scoreArray`. Loop through the input `operations` and using a switch block look at each element to determine the operation to perform. 
